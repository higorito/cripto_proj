...
class MoedaRepositorio {  //depois colocar via API
  static List<MoedaModel> tabelaMoedas = [
    MoedaModel(icone: 'assets/icons/bitcoin.png', nome: 'Bitcoin', sigla: 'BTC', cotacao: 29281.10),
    MoedaModel(icone: 'assets/icons/ethereum.png', nome: 'Ethereum', sigla: 'ETH', cotacao: 1844.60),
    MoedaModel(icone: 'assets/icons/xrpname.png', nome: 'XRP', sigla: 'XRP', cotacao: 0.6740),
